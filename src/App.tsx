      ...
      <BrowserRouter>
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/laboratorio/cuenta-corriente" element={
              <Private><CuentaCorrienteLaboratorio /></Private>
            } />
            <Route path="/laboratorio/nomina" element={
              <RoleProtected roles={["admin", "recepcion"]}><NominaLaboratorios /></RoleProtected>
            } />

...
export const DEFAULT_PERMISSIONS: Record<AppRole, Record<string, Record<PermissionAction, boolean>>> = {
  ...
  recepcion: {
    ...
    recetas_externas: { read: true, create: false, update: false, delete: false },
    odontograma: { read: true, create: false, update: false, delete: false },
    ...
    laboratorios: { read: true, create: true, update: true, delete: false },
  ...
  profesional: {
    ...
    recetas_externas: { read: true, create: true, update: true, delete: false },
    odontograma: { read: true, create: true, update: true, delete: false },
    ...
    cobros: { read: false, create: true, update: false, delete: false },
    presupuestos: { read: true, create: false, update: false, delete: false },
    laboratorios: { read: true, create: true, update: false, delete: false },
    seguridad_usuarios: { read: false, create: false, update: false, delete: false },
    seguridad_perfiles: { read: false, create: false, update: false, delete: false },
    auditoria: { read: false, create: false, update: false, delete: false },
  ...
  manager: {
    ...
    bloqueos_agenda: { read: false, create: false, update: false, delete: false },
    atenciones: { read: false, create: false, update: false, delete: false },
    recetas_externas: { read: false, create: false, update: false, delete: false },
    odontograma: { read: false, create: false, update: false, delete: false },
    prestaciones: { read: false, create: false, update: false, delete: false },
    obras_sociales: { read: false, create: false, update: false, delete: false },
    cobros: { read: true, create: false, update: false, delete: false },
    presupuestos: { read: false, create: false, update: false, delete: false },
    laboratorios: { read: false, create: false, update: false, delete: false },
    seguridad_usuarios: { read: false, create: false, update: false, delete: false },
    seguridad_perfiles: { read: false, create: false, update: false, delete: false },
    auditoria: { read: false, create: false, update: false, delete: false },
    reportes: { read: true, create: false, update: false, delete: false },
